...
TEST_CASE("Carrinho - fluxo principal de livros") {
    Cliente cliente("Cliente nome", "cliente@email.com", "senha123", "12345678900");
...
TEST_CASE("Carrinho - regras de frete") {
    Cliente cliente("Cliente nome", "clientetwo@email.com", "senha123", "11111111111");
    Carrinho carrinho(cliente);
...
TEST_CASE("Carrinho - casos invalidos") {
    Cliente cliente("Cliente nome", "clientethree@email.com", "senha123", "99999999999");
    Carrinho carrinho(cliente);
